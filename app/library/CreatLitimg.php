 ...
 *
 */
class CreatLitimg extends File{
	 ...
	 */
	public function __construct($_file, $savePath, $saveName) {
		$this->file = $_file;
	 ...
	 */
	public function litimg($new_width=0, $new_height=0) {
		if (!$this->errorState){
	...
	private function out() {
		imagepng($this->new, $this->filePath.'/'.$this->saveName);//第二个参数为新生成的图片名
