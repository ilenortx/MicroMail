    ...
    private function getCreateRequestData($data){    // 电子面单数组
        $return_data = array(
            ...
            "Receiver"=>array(
                ...
                "PostCode"=>"",
                "ProvinceName"=>$data['order']['address'][0],
                "CityName"=>isset($data['order']['address'][1])? $data['order']['address'][1]:'',
                "ExpAreaName"=>isset($data['order']['address'][2])? $data['order']['address'][2]:'',
                "Address"=>isset($data['order']['address'][3])? ($data['order']['address'][3] . $data['order']['address_xq']):$data['order']['address_xq'],
            ),
            "Sender"=>array(
                "Company"=>"",
                ...
                "ExpAreaName"=>isset($data['area'][2])? $data['area'][2]:'',
                "Address"=>isset($data['area'][3])? ($data['area'][3] . $data['shipAddress']['address']):$data['shipAddress']['address'],
            ),
            "IsNotice"=>1,
            "StartDate"=>"",
            "EndDate"=>"",
