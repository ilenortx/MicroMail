    ...
    <body style="min-height:auto">
            ...
            <table id="userListDataTables" class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <tbody>
                    ...
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                        	{% if scType=='ST0' %}
                        		<a style="text-decoration:none" href="../ShopManagement/txdPage?msid={{list['id']}}" title="提现">
		                        	详情
		                        </a>
                        	{% else %}
                        		{% if list['status']=='S0' or list['status']=='S2' %}
                        			<a style="text-decoration:none" onclick="sqtx(this,{{ list['id'] }})" href="javascript:;" title="提现">
		                            	<label style="color:green;">提交提现</label>
		                            </a>
                        		{% elseif list['status']=='S1' %}
                        			<label style="color:red;">审核中</label>
                        		{% endif %}
                        	{% endif %}
                        </td>
                    </tr>
        ...
        <script>
            ...
            function sqtx(obj, id) {
                ...
                function(index) {
                    $.post('../ShopManagement/sqtx', {'msid':id}, function(data){
