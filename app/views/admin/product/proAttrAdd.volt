        	...
        	<form class="form form-horizontal" enctype="multipart/form-data" method="post">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<div class="radio-box">
						    <input type="radio" class="type" name="type" value="T1" {% if attrInfo['type']=='T1' %} checked="checked" {% endif %}>
						    <label for="radio-1">全部产品</label>
						</div>
						<div class="radio-box" style="margin-left:20px">
						    <input type="radio" class="type" value="T2" name="type" {% if attrInfo['type']=='T2' %} checked="checked" {% endif %}>
                    ...
                    <div class="formControls col-xs-8">
                    	...
                    	<div class='values'>
                    		<table id="val-tab" class='val-table var-values-table'>
                    			{% set item=0 %}
                    			{% for val in attrInfo['values'] %}
			                    <tr class='val-tr {% if item%2 %}val-tr-bg2{% else %}val-tr-bg1{% endif %}'>
