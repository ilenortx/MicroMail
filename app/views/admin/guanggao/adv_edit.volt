    ...
    <form class="form form-horizontal" action="../Guanggao/addAdv" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" id="position" name="position">
                    ...
                    <option value="1" {% if adinfo['position']==1 %} selected="selected" {% endif %}>&nbsp;- 首页轮播</option>
                </select>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" id="type" name="type">
                    <option value="">无</option>
                    <option value="index" {% if adinfo['type']==1 %}selected="selected" {% endif %}>首页</option>
                </select>
            </div>
        </div>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                ...
                {% if adinfo['id'] %} <input type="hidden" name="adv_id" id="adv_id" value="{{ adinfo['id'] }}"> {% endif %}
            </div>
        </div>
    </form>
</div>
