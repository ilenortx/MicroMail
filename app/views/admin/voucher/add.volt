...
<html>
    ...
    <body style="min-height:auto">
        <nav class="navb"><div class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>优惠券管理<span class="c-gray en">&gt;</span>{% if vid %}<a href="../Voucher/index">全部优惠券</a> <span class="c-gray en">&gt;</span> 编辑优惠券 {% else %} 新增优惠券 {% endif %} <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></div></nav>
		<div class="page-container">
		    <form class="form form-horizontal" action="../Voucher/vouSave" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
		        ...
		        {% if (vinfo['proid']!='all' and vinfo['proid']!='' and vinfo['pro_list']) %}
		        <li>
		            <div class="d1">已选产品:</div>
		            <div>
		                {% for list in vinfo['pro_list'] %}
		        ...
		        <div class="row cl">
		            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
		                ...
		                {% if vinfo['id'] %}<input type="hidden" name="id" id='id' value="{{ vinfo['id'] }}">{% endif %}
		            </div>
		        </div>
		    </form>
        </div>
