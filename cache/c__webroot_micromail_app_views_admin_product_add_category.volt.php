...
<nav class="navb"><div class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 分类管理 <span class="c-gray en">&gt;</span> <?php if ($edit) { ?>分类编辑<?php } else { ?>新增分类<?php } ?> <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></div></nav>
    ...
    <form class="form form-horizontal" action="../Category/save" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                ...
                <img onclick="cppvw('file','photofPvw');" id="photofPvw" src="<?php if ($cginfo['bz_1']) { ?>../files/uploadFiles/<?= $cginfo['bz_1'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:125px;height:125px"  >
