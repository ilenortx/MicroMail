...
<html>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <table id="userListDataTables" class="table table-border table-bordered table-bg">
                <thead>
                    <tr>
                ...
                <tbody>
                	<?php foreach ($userLists as $userInfo) { ?>
                    <tr class="text-c">
                        <td>
                        ...
                        <td><?= $userInfo['addtime'] ?></td>
                        <td class="td-status">
                        	<?php if ($userInfo['status'] == 'S0') { ?>
                            <span class="label label-default radius">已禁用</span>
                        	<?php } elseif ($userInfo['status'] == 'S1') { ?>
                            <span class="label label-success radius">已启用</span>
                            <?php } ?>
                        </td>
                        <td class="td-manage">
                        	<?php if ($userInfo['status'] == 'S0') { ?>
                        	<a style="text-decoration:none" onclick="admin_start(this,<?= $userInfo['id'] ?>)" href="javascript:;" title="启用">
                            	<i class="Hui-iconfont">&#xe615;</i>
                            </a>
                            <?php } elseif ($userInfo['status'] == 'S1') { ?>
                            <a style="text-decoration:none" onClick="admin_stop(this,<?= $userInfo['id'] ?>)" href="javascript:;" title="停用">
                                <i class="Hui-iconfont">&#xe631;</i>
                            </a>
                            <?php } ?>
                            <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','admin-add.html',<?= $userInfo['id'] ?>,'800','500')" class="ml-5" style="text-decoration:none">
                                <i class="Hui-iconfont">&#xe6df;</i>
                            </a>
                            <a title="删除" href="javascript:;" onclick="admin_del(this,<?= $userInfo['id'] ?>)" class="ml-5" style="text-decoration:none">
                                <i class="Hui-iconfont">&#xe6e2;</i>
                            </a>
                        </td>
                    </tr>
