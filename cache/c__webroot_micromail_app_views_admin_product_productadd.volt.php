                        ...
                        <div class="layui-tab-item">
                            <div class="row cl">
                                ...
                                <div class="formControls col-xs-8 col-sm-3">
                                    ...
                                    <img onclick="cppvw('photo_x','photoxPvw');" id="photoxPvw" src="<?php if ($proInfo['photo_x']) { ?>../files/uploadFiles/<?= $proInfo['photo_x'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:80px;height:80px"  >
                            ...
                            <div class="row cl">
                                ...
                                <div class="formControls col-xs-8 col-sm-3">
                                    ...
                                    <img onclick="cppvw('photo_d','photodPvw');" id="photodPvw" src="<?php if ($proInfo['photo_d']) { ?>../files/uploadFiles/<?= $proInfo['photo_d'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:125px;height:125px"  >
                            ...
                            <div class="row cl">
                                ...
                                <div class="formControls col-xs-8 col-sm-3">
                                    <img onclick="cppvw('photo_tjx','phototjxPvw');" id="phototjxPvw" src="<?php if ($proInfo['photo_tjx']) { ?>../files/uploadFiles/<?= $proInfo['photo_tjx'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:100px;height:100px"  >
                            ...
                            <div class="row cl">
                                ...
                                <div class="formControls col-xs-8 col-sm-3">
                                    <img onclick="cppvw('photo_tj','phototjPvw');" id="phototjPvw" src="<?php if ($proInfo['photo_tj']) { ?>../files/uploadFiles/<?= $proInfo['photo_tj'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:180px;height:120px"  >
                            ...
                            <div class="row cl">
                                ...
                                <div class="formControls col-xs-8 col-sm-3">
                                    ...
                                    <select name="procxid" id="procxid" style="width:150px;margin-right:5px;">
                                        ...
                                        <?php foreach ($cxlist as $cx) { ?>
                                        <option value="<?= $cx['id'] ?>" <?php if ($cx['id'] == $proInfo['procxid']) { ?>selected="selected"<?php } ?>><?= $cx['name'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row cl">
                                <div class="formControls col-xs-8 col-sm-3" style="width:600px;">
                                    ...
                                    <ul>
                                        ...
                                        <li><label><input <?php if ($val['checked'] == 1) { ?>checked="checked"<?php } ?> type="checkbox" class="sku_value" propid="<?= $attr['id'] ?>" propvalid='<?= $val['id'] ?>' value="<?= $val['name'] ?>" /><?= $val['name'] ?></label></li>
                                        <?php } ?>
                                    </ul>
                                    <div class="clear"></div>
                                    <?php } ?>
