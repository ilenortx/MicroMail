...
<nav class="navb"><div class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广告管理 <?php if ($noticeInfo['id']) { ?><span class="c-gray en">&gt;</span> <a href="../Guanggao/noticePage">全部公告</a> <?php } ?><span class="c-gray en">&gt;</span> 新增公告 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></div></nav>
    ...
    <form class="form form-horizontal" action="../Guanggao/addNotice" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                ...
                <?php if ($noticeInfo['id']) { ?> <input type="hidden" name="notice_id" id="notice_id" value="<?= $noticeInfo['id'] ?>"> <?php } ?>
            </div>
        </div>
    </form>
</div>
