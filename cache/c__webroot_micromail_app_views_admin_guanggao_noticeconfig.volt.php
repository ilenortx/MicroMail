        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" name="direction" id="direction">
                    <option value="1" id="" <?php if ($ncInfo['direction'] == 1) { ?>selected="selected"<?php } ?>>向左</option>
                    <option value="2" id="" <?php if ($ncInfo['direction'] == 1) { ?>selected="selected"<?php } ?>>向右</option>
                </select>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" name="speed" id="speed">
                    <option value="1" id="" name="gdfx" <?php if ($ncInfo['speed'] == 1) { ?>selected="selected"<?php } ?>>慢速</option>
                    <option value="2" id="" name="gdfx" <?php if ($ncInfo['speed'] == 2) { ?>selected="selected"<?php } ?>>常速</option>
                    <option value="3" id="" name="gdfx" <?php if ($ncInfo['speed'] == 3) { ?>selected="selected"<?php } ?>>快速</option>
                </select>
            </div>
        </div>
