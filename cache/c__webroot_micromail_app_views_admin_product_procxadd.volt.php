        	...
        	<form id="proCxForm" class="form form-horizontal" enctype="multipart/form-data" method="post">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<img onclick="cppvw('photo','photoPvw');" id="photoPvw" src="<?php if ($cxInfo['photo']) { ?>../files/uploadFiles/<?= $cxInfo['photo'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" >
						<input id="photo" name="photo" htp="<?php if ($cxInfo['photo']) { ?>1<?php } else { ?>0<?php } ?>" class="choosePhotoIpt" accept="image/*" type="file" />
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>广告图：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<img onclick="cppvw('adphoto','photoadPvw');" id="photoadPvw" src="<?php if ($cxInfo['adphoto']) { ?>../files/uploadFiles/<?= $cxInfo['adphoto'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" >
						<input id="adphoto" name="adphoto" htp="<?php if ($cxInfo['adphoto']) { ?>1<?php } else { ?>0<?php } ?>" class="choosePhotoIpt" accept="image/*" type="file" />
					</div>
				</div>
					<label class="form-label col-xs-4 col-sm-3">主区配置：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<div class="hui-form-radios" style="line-height:38px;">
					        <input type="radio" value="S1" name="sstyle" class="sstyle" id="sst1" onChange="rePros()" <?php if ($cxInfo['sstyle'] == 'S1') { ?>checked="checked"<?php } ?> /><label for="sst1">单列布局</label>
					        <input type="radio" value="S2" name="sstyle" class="sstyle" id="sst2" onChange="rePros()" <?php if ($cxInfo['sstyle'] == 'S2') { ?>checked="checked"<?php } ?> /><label for="sst2">双列布局</label>
					    </div>
					</div>
				<div class="row cl">
