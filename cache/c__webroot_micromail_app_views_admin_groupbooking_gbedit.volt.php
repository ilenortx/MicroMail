        	...
        	<form class="form form-horizontal">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
		            	...
		            	name="stime" id="stime" value="<?= $gbInfo['stime'] ?>" style="width:160px;" <?php if ($type == 'edit') { ?>disabled="disabled" readonly="readonly"<?php } ?>>
		            	至
		            	<input type="text" onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'stime\')}' })" placeholder="失效时间"
		            	id="etime" name="etime" value="<?= $gbInfo['etime'] ?>" class="input-text Wdate" style="width:160px;" <?php if ($gbInfo['status'] == 'S3') { ?>disabled="disabled" readonly="readonly"<?php } ?>>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">成团人数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="number" class="input-text" value="<?= $gbInfo['mannum'] ?>" id="mannum" name="mannum" style="width:160px" oninput="inputNumVerify('mannum')" min="2" max="8" <?php if ($type == 'edit') { ?>disabled="disabled" readonly="readonly"<?php } ?>>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="number" class="input-text" value="<?= $gbInfo['gbtime'] ?>" id="gbtime" name="gbtime" style="width:160px" step="0.01" <?php if ($type == 'edit') { ?>disabled="disabled" readonly="readonly"<?php } ?>> 小时
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?= $gbInfo['gbprice'] ?>" id="gbprice" name="gbprice" style="width:160px" <?php if ($type == 'edit') { ?>disabled="disabled" readonly="readonly"<?php } ?>>
					</div>
				</div>
				<div class="row cl">
