				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'price_yh', width:100, sort:true,}">价格/元</th>
					 	...
					 	<th lay-data="{field:'stype', width:80, align:'center', fixed:'right'}">推荐</th>
					  	<th lay-data="{field:'operate', width:160, fixed:'right',style:'height:91px;'}">操作</th>
					</tr>
				</thead>
			</table>
            <!-- <table id="userListDataTables" class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                <tbody>
                    ...
                    <tr class="text-c">
		                ...
		                <td class="td-status"><?php if ($list['stype'] == 1) { ?><label style="color:green;">推荐</label><?php } ?></td>
                        <td class="td-manage">
                        	<?php if ($list['stype'] != 1) { ?>
