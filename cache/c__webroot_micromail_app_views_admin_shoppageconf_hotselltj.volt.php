            ...
            <form id="activityArea" class="form form-horizontal">
				<div class="row cl"><!-- 主区配置 -->
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<img onclick="cppvw('photo_l','photolPvw');" id="photolPvw" src="<?php if ($hstconf['zphoto']) { ?>../files/uploadFiles/<?= $hstconf['zphoto'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:125px;height:200px"  >
						<input id="photo_l" class="choosePhotoIpt" name="photo_l" hphoto="<?php if ($hstconf['id']) { ?>1<?php } else { ?>0<?php } ?>" accept="image/*" type="file" />
					</div>
				</div>
				<div class="row cl"><!-- 右上配置 -->
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<img onclick="cppvw('photo_rt','photortPvw');" id="photortPvw" src="<?php if ($hstconf['rtphoto']) { ?>../files/uploadFiles/<?= $hstconf['rtphoto'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:125px;height:90px"  >
						<input id="photo_rt" class="choosePhotoIpt" name="photo_rt" hphoto="<?php if ($hstconf['id']) { ?>1<?php } else { ?>0<?php } ?>" accept="image/*" type="file" />
					</div>
				</div>
				<div class="row cl"><!-- 右下配置 -->
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<img onclick="cppvw('photo_rb','photorbPvw');" id="photorbPvw" src="<?php if ($hstconf['rbphoto']) { ?>../files/uploadFiles/<?= $hstconf['rbphoto'] ?><?php } else { ?>../img/coustom/click.png<?php } ?>" class="choosePhotoImg" style="margin-bottom: 3px;width:125px;height:90px"  >
						<input id="photo_rb" class="choosePhotoIpt" name="photo_rb" hphoto="<?php if ($hstconf['id']) { ?>1<?php } else { ?>0<?php } ?>" accept="image/*" type="file" />
					</div>
				</div>
